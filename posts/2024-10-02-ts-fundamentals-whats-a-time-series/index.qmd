...
The art of forecasting is just taking historical time series data, and feeding it into a model that can learn from historical [trends](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#trend) and [seasonality](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#seasonality) patterns. Ultimately creating a future prediction for the next few periods of time. 

Most regression models in machine learning can be turned into a time series forecast model by the process of incorporating time dependant data as features through a process called [feature engineering](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#feature-engineering). A [feature](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#feature) is just a variable in your dataset that can be used to help predict your [target variable](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#target-variable). The process of creating features before you train a model is called feature engineering. The target variable is what you want to predict going forward. These machine learning regression models can be thought of as [multivariate models](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#multivariate-model), since they can incorporate many different variables or features into a model. 
...
There are also models that only exist in the world of time series forecasting. These are more statistical models and less machine learning models. Meaning they operate like equations that can applied to your data compared to a machine learning model that tries to learn the patterns underlying the data. These models are often [univariate](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#univariate-model), which means that you only need the historical target variable values accompanied by a [timestamp](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#timestamp) (list of dates) to train these models. While they might be simple in nature, they are still very useful even today. Often beating more complex models like [deep learning](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#deep-learning). 
