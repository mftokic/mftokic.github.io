...
Every single time series you have ever seen has a [trend](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#trend) and [seasonality](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#seasonality). If they don't, then they are random [white noise](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#white-noise). A trend is just values steadily rising or falling over time. You could have a rising trend in some years, then a falling trend in others. Below is a chart with a strong trend but weak seasonality. 
...
Finally we can get the final piece of our decomposition, the [remainder](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#remainder) (aka [residual](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#residual)) series. This is everything that couldn't be explained by the trend and seasonal components. Simply take the original revenue time series, subtract the trend and seasonal components, and bam you have the remainder series.

![](./chart6.png)

### STL Decomposition

The additive decomposition approach can work very well if your data has a linear trend and stable seasonality. But if the series is growing exponentially, or has changing seasonality, then more advanced methods are needed. This is where STL decomposition comes in. STL is an acronym for “Seasonal and Trend decomposition using Loess”, while [loess](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#loess) is a smoothing method for estimating nonlinear relationships. This smoothing process allows for changing seasonality, a more complex understanding of the trend component, and more resistance to [outliers](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#outlier). Here is the STL process broken down step by step. 
...
Here is the output of a STL decomposition. Each component can be added together to get the original time series, just like [additive decomposition](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#additive-decomposition). 
