...
Looks like our future forecast for each model doesn't look good. No [trends](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#trend) were captured, same goes for [seasonality](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#seasonality) outside of the seasonal naive model. These models produced future forecasts, just none that we want to use for our final forecast.
...
- **[Random Walk with Drift](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#random-walk-with-drift)**
...
- **Growth Rate Forecast Methods**
    - If the time series lacks seasonality, you can apply a [compound annual growth rate (CAGR)](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#compound-annual-growth-rate) or similar average growth over "xyz" time periods and apply that to create a future forecast. 
