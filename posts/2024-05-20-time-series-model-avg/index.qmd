...
| Model       |    MAPE   |    MAE     |   RMSE    |
|-------------|-----------|------------|-----------|
| arima       |  1.973448 |  3.760466  |  4.676953 |
| croston     | 10.182240 | 19.542784  | 20.004738 |
| nnetar      |  9.770954 | 18.368904  | 26.001192 |
| stlm-ets    |  1.924362 |  3.682060  |  4.590760 |
| tbats       |  1.855084 |  3.513180  |  4.049060 |
| theta       |  2.464353 |  4.717486  |  5.524042 |
...
| Model                |    MAPE   |    MAE     |   RMSE    |
|----------------------|-----------|------------|-----------|
| arima_stlm-ets_tbats |  1.844505 |  3.511298  |  3.993039 |
...
Simple model averages are often the quickest way to improved forecast accuracy. Another way is to create an ensemble model that can create the weights on it's own. Let's feed the predictions from each model into a linear regression model and have it determine the optimal weights. Note, I'm intentionally skipping over the process of having separate test and validation sets for this kind of ensembling approach, which is a topic for another day. 
