...
Finally there are other ways to figure out the importance of external regressors, but most of them deal with training actual models. I'll wait on discussing those techniques until we build up some more foundational knowledge and eventually get the to sections on models themselves. Stay tuned. 
