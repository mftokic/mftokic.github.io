...
Some people create a "porfolio" of projects and have it live on their GitHub. I don't think that's a good idea. Real work is messy, and is the best indicator of future performance to an employer. Projects in a portfolio allow you to control all the variables, which is not how the real world works. 

You can have public GitHub repos that show as samples of your work. But they should not be sample projects. They should either be pieces of work that you applied in your real job made open source and accessable to others. Or side projects where you wanted to build something cool to help you in your personal life. For example if you built your own website for your wedding, and had the code in a GitHub repo for hiring managers to see your coding chops. 

### AI is Your Friend

In this post ChatGPT era, all technical work becomes 100x easier to learn. You don't need school, or even books. You can, for free, start using a large language model (LLM) to start learning coding concepts and even have it ask you technical questions to test your learning. 
...
Learning to code is important. Life is all about leverage. The best types of leverage in the world are permissionless leverage. Things with no marginal costs of replication. This kind of leverage are things like code and content (podcasts, blog posts, etc.). 

Most people want to be managers. That's another type of leverage, labor or human capital leverage. Pretty soon everyone will be a manager, just not managing people. But instead managing AI people, or bots, who will do your work for you.

It takes guts to move to a new field. People who just do what their boss tells them to do will never have the guts to do it. It takes a certain amount of agency to do it. If you are considering or are already in the process of doing it, I salute you. The world needs more people like you. Good luck!