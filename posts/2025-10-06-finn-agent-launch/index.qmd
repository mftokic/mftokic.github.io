...
These big three come directly from Microsoft's CFO, Amy Hood. In terms of which one is the most important, my vote would be for looking forward. That's the essence of finance, making decisions about the future. Looking backward is for accountants. What makes finance fun is using data to make decisions about an uncertain future.

In order to make decisions about the future, you have to make a guess or prediction about what the future might be. This is the practice of forecasting. In finance our forecasts are based on numbers, which are in the form of a time series (numbers over time). Being able to forecast these time series effectively allows the CFO and the rest of the company to make the best decisions. The most important job you can do in finance is to make high quality time series forecasts. 
