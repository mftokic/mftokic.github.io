...
### Economics of AI  
- **Jevons Paradox:** Lowering the cost of AI increases its usage dramatically ([Wikipedia](https://en.wikipedia.org/wiki/Jevons_paradox)).
...
- Chinese companies circumvent U.S. Nvidia GPU export bans by routing purchases through third-party vendors in Singapore ([Reuters](https://www.reuters.com/technology/chinese-companies-bypass-chip-export-controls-via-singapore-2023-05-17/)).
...
- Prolonged sitting significantly increases mortality risk; offset by regular activity and frequent movement breaks ([NCBI](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3404815/)).
...
- Hangul invented explicitly due to difficulty in learning complex Chinese characters. Designed for rapid acquisition, enhancing widespread literacy ([Wikipedia](https://en.wikipedia.org/wiki/Hangul)).

### Stanford’s "Touchy-Feely" Class  
- "Interpersonal Dynamics" at Stanford GSB teaches emotional intelligence, authentic communication, and relationship-building skills via experiential T-group sessions ([Stanford GSB](https://www.gsb.stanford.edu/exec-ed/programs/interpersonal-dynamics-weekend-lab)).
...
- Epstein-Barr virus (mono) infection necessary precursor for multiple sclerosis ([NIH](https://www.nih.gov/news-events/news-releases/epstein-barr-virus-linked-multiple-sclerosis)).
- Icelandic dating app created by the government prevents accidental familial relationships ([Washington Post](https://www.washingtonpost.com/news/worldviews/wp/2013/04/18/in-iceland-a-country-of-cousins-a-website-to-avoid-incest/)).
