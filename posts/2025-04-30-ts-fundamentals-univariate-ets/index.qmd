...
Exponential smoothing is a family of forecasting methods that smooth out short-term fluctuations in data to reveal underlying trends or patterns. The core idea is to give more weight to recent observations and less weight to older data, which produces a "smoothed" time series with reduced [noise](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#noise). This makes it easier to spot patterns and predict future values. 
...
- **When outside forces rule the game (promotions, ad spend, macro shocks)**
    - ETS is [univariate](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#univariate-model), if your forecast errors line up with random one time events, you’re in the wrong model.
