...
There's a saying that 80% of ML projects [never make it into production](https://d2iq.com/blog/why-87-of-ai-ml-projects-never-make-it-into-production-and-how-to-fix-it). This definitely applies to ML forecasting, but in a different way. Better put, 80% of ML forecast projects never make it past the triangulation point phase. 
...
- If accuracy is a concern, establish a benchmark to beat. 
- Squeaky wheel gets the grease. Constant contact with the end ML forecast user helps speed things up. 
