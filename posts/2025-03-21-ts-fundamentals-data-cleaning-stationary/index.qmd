...
In the world of forecasting, many models need the [trend](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#trend) component to be removed in order to learn the right [signal](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#signal) from the data. The process of removing a trend (and sometimes [seasonality](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#seasonality)) is called differencing, which can make a time series become stationary. 

Stationary just means that the time series has a constant mean and [variance](https://mftokic.github.io/posts/2024-09-25-ts-fundamentals-glossary/#variance) over time. Put simpler, it's a time series that looks kind of random with no discernable trend or repeating seasonality. If a time series does have a trend, then we can remove it through a process called differencing, which involves subtracting a value in one time period from a value in a previous time period. More on this later. 
