...
2. A 95% prediction interval. This represents with 95% certainty the upper and lower ranges where the model thinks the future value will land between. The tighter this interval the more confident the model has in its prediction. We will dig deep into prediction intervals in more detail in a later post. 
